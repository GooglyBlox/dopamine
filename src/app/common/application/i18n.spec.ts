...
describe('validate i18n', () => {
    const validKeys = [
        ...
        'refresh-missing-artist-images',
        'refresh-now',
        'refresh-replaygain',
        'refresh-replaygain-existing-tracks',
        'refresh-themes',
        'refreshing',
        ...
        'releases-in-days',
        'releases-filter-all',
        'releases-filter-upcoming',
        'releases-filter-past-30',
        'releases-filter-past-year',
        'releases-type-all',
        'releases-type-album',
        'releases-type-ep',
        'releases-type-single',
        'releases-empty-no-followed',
        'releases-empty-syncing',
        'releases-empty-no-results',
        'releases-copy-artist',
        'releases-copy-title',
        'releases-copy-artist-and-title',
        'releases-open-musicbrainz',
        'releases-hide',
        'releases-click-to-copy-title',
        'releases-click-to-copy-artist',
        'follow-artist',
        'unfollow-artist',
        'release-calendar',
        'release-calendar-sync-interval',
        'copied-to-clipboard',
        'pick-musicbrainz-artist',
        'pick-musicbrainz-artist-description',
        'pick-musicbrainz-artist-no-results',
        'score',
        'follow',
        'followed-artists',
        'followed-artists-empty',
        'releases-status-resolved',
        'releases-status-not-found',
        'releases-status-failed',
        'releases-status-unresolved',
        'releases-mb-as',
